	...
	<view class="login" :class="{show:show}">
		...
		<view class="container">
			...
			<u-form :model="form" ref="uForm" v-show="!getUserInfoTag">
				...
				<view class="type">
					<u-subsection active-color="#007cba" font-size="20" height="52" :list="subsectionList"
						:current="curRow" @change="sectionChange"></u-subsection>
				</view>
			</u-form>
